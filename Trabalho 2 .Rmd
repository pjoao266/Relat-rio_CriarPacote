...
A documentação é um dos aspectos mais importantes de um bom pacote. Sem ele, os usuários não saberão como usar seu pacote. A documentação também é útil para desenvolvedores que queiram estender seu pacote.
